...
use App\Models\{Product, Variations, Category, VariationImages, ProductGallery, Notification, ProductRequest};
...
class AdminProductsController extends Controller
{
    ...
    public function lists()
    {
        ...
        if ($admin_type == 'admin') {
            ...
            $products = Product::where('added_by', Auth::guard('admin')->user()->id)
                ->orderBy('id', 'desc')
                ->get();
        }
