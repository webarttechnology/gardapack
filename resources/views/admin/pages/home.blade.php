                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->btn1_txt }} @endif" name="btn1_txt">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->btn1_link }} @endif" name="btn1_link">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->btn2_txt }} @endif" name="btn2_txt">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->btn2_link }} @endif" name="btn2_link">
                            ...
                            <div class="">
                                <label class="form-label">Banner Description</label>
                                 <textarea class="ckeditor form-control" name="banner_des">@if($data != null ) {!! $data->banner_des !!} @endif</textarea> 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->home_about_heading }} @endif" name="home_about_heading">
                            ...
                            <div class="">
                                <label class="form-label">Home About Description</label>
                                 <textarea class="ckeditor form-control" name="home_about_des">@if($data != null) {{ $data->home_about_des }} @endif</textarea> 
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="home_about_video" value="@if($data != null) {{ $data->home_about_video }} @endif" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  value="@if($data != null) {{ $data->feature_heading }} @endif" name="feature_heading">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_banners/'.$data->feature_banner) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_side_imgs/'.$data->feature_side_img) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_img_1/'.$data->feature_img_1) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                <label class="form-label">Feature Title 1</label> 
                                 <input type="text" class="form-control" name="feature_title_1" value="@if($data != null) {{ $data->feature_title_1 }} @endif">
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="feature_description_1">@if($data != null) {{ $data->feature_description_1 }} @endif</textarea>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_img_2/'.$data->feature_img_2) }}" width="200" alt="banner">
                                @endif
                                <br> 
                            ...
                            <div class="">
                                <label class="form-label">Feature Title 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->feature_title_2 }} @endif" name="feature_title_2">
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="feature_description_2">@if($data != null) {{ $data->feature_description_2 }} @endif</textarea>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_img_3/'.$data->feature_img_3) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                <label class="form-label">Feature Title 3</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->feature_title_3 }} @endif" name="feature_title_3">
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="feature_description_3">@if($data != null) {{ $data->feature_description_3 }} @endif</textarea>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_img_4/'.$data->feature_img_4) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                <label class="form-label">Feature Title 4</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->feature_title_4 }} @endif" name="feature_title_4">
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="feature_description_4">@if($data != null) {{ $data->feature_description_4 }} @endif</textarea>
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/feature_img_5/'.$data->feature_img_5) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                <label class="form-label">Feature Title 5</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->feature_title_5 }} @endif" name="feature_title_5">
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="feature_description_5">@if($data != null) {{ $data->feature_description_5 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Offer Title 1</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_title_1 }} @endif" name="offer_title_1">
                            ...
                            <div class="">
                                <label class="form-label">Offer Subtitle 1</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_subtitle_1 }} @endif" name="offer_subtitle_1">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/offer_banner_1/'.$data->offer_banner_1) }}" width="200" alt="banner">
                                @endif
                                <br> 
                            ...
                            <div class="">
                                <label class="form-label">Offer Link 1</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_link_1 }} @endif" name="offer_link_1">
                            ...
                            <div class="">
                                <label class="form-label">Offer Title 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_title_2 }} @endif" name="offer_title_2">
                            ...
                            <div class="">
                                <label class="form-label">Offer Subtitle 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_subtitle_2 }} @endif" name="offer_subtitle_2">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/offer_banner_2/'.$data->offer_banner_2) }}" width="200" alt="banner">
                                @endif
                                <br>  
                            ...
                            <div class="">
                                <label class="form-label">Offer Link 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->offer_link_2 }} @endif" name="offer_link_2">
                            ...
                            <div class="">
                                <label class="form-label">Explore Technology Heading</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->explore_tech_heading }} @endif" name="explore_tech_heading">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/explore_tech_banner/'.$data->explore_tech_banner) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                <label class="form-label">Technology Title 1</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->tech_title_1 }} @endif" name="tech_title_1">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/tech_img_1/'.$data->tech_img_1) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="technology_description_1">@if($data != null) {{ $data->technology_description_1 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Technology Title 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->tech_title_2 }} @endif" name="tech_title_2">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/tech_img_2/'.$data->tech_img_2) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="technology_description_2">@if($data != null) {{ $data->technology_description_2 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Technology Title 3</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->tech_title_3 }} @endif" name="tech_title_3">
                            ...
                            <div class="">
                                ...
                                <br>
                                @if($data != null)
                                    <img src="{{ asset('uploads/tech_img_3/'.$data->tech_img_3) }}" width="200" alt="banner">
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="technology_description_3">@if($data != null) {{ $data->technology_description_3 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Heading</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->why_us_heading }} @endif" name="why_us_heading">
                            ...
                            <div class="">
                                <label class="form-label">Title - 1</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->why_us_title_1 }} @endif" name="why_us_title_1">
                            ...
                            <div class="">
                                ...
                                @if($data->why_us_img_1 != null)
                                    <img src="{{ asset('uploads/why_us_img_1/'.$data->why_us_img_1) }}" width="200" alt="banner">
                                @endif
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="why_us_desc_1">@if($data != null) {{ $data->why_us_desc_1 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Title - 2</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->why_us_title_2 }} @endif" name="why_us_title_2">
                            ...
                            <div class="">
                                ...
                                @if($data->why_us_img_2 != null)
                                    <img src="{{ asset('uploads/why_us_img_2/'.$data->why_us_img_2) }}" width="200" alt="banner">
                                @endif
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="why_us_desc_2">@if($data != null) {{ $data->why_us_desc_2 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Title - 3</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->why_us_title_3 }} @endif" name="why_us_title_3">
                            ...
                            <div class="">
                                ...
                                @if($data->why_us_img_3 != null)
                                    <img src="{{ asset('uploads/why_us_img_3/'.$data->why_us_img_3) }}" width="200" alt="banner">
                                @endif
                                @endif
                                <br>
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="why_us_desc_3">@if($data != null) {{ $data->why_us_desc_3 }} @endif</textarea>
                            ...
                            <div class="">
                                <label class="form-label">Title - 4</label> 
                                 <input type="text" class="form-control" value="@if($data != null) {{ $data->why_us_title_4 }} @endif" name="why_us_title_4">
                            ...
                            <div class="">
                                ...
                                @if($data->why_us_img_4 != null)
                                    <img src="{{ asset('uploads/why_us_img_4/'.$data->why_us_img_4) }}" width="200" alt="banner">
                                @endif
                                @endif
                                <br> 
                            ...
                            <div class="">
                                ...
                                <textarea class="ckeditor form-control" name="why_us_desc_4">@if($data != null) {{ $data->why_us_desc_4 }} @endif</textarea>
                            ...
                            <div class="">
                                ...
                                @if($data->faq_banner != null)
                                    <img src="{{ asset('uploads/faq_banner/'.$data->faq_banner) }}" width="200" alt="banner">
                                @endif
                                @endif
                                <br> 
