        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    <div>
                        <a href="{{ url('admin/product/gallery/lists', $products->id) }}"><button
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select name="categories" id="categories" class="select2-field form-control"
                                        onchange="subCategoryDetails()">
                                ...
                                <div id="stock_div_1" style="display: block">
                                    @if ($products->stock_status == 'In Stock')
                                        <div class="" id="">
                                            ...
                                            <input type="number" class="form-control" name="no_in_stock"
                                                value="{{ $products->no_in_stock }}" />
                                        </div>
                                    @endif
                                </div>
                                <br>
                                ...
                                <div class="" id="no_in_stock_div">
                                    ...
                                    <input type="checkbox" name="qty_checkbox" id="qty_checkbox"
                                        @if ($products->qty_check != null) checked @endif onclick="QtyAdd()">
                                </div>
                                <br>
                                ...
                                <div id="existing_var" >
                                    @foreach ($variations as $key => $variation)
                                        @if ($variation->variation != 'NA')
                                            <div class="row">
                                                <div class="borderBp" id="variations_{{ $key }}">
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            <label>Variation</label>
                                                            <input type="text" name="ropeChain[]"
                                                    ...
                                                    <div class="col-md-12 col-12 mt-3">
                                                        <div class="form-group">
                                                            ...
                                                            @if ($errors->has('final_price'))
                                                                <span
                                                                    class="text-danger">{{ $errors->first('final_price') }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 col-12 rope-chan mt-3">
                                                        ...
                                                        <span class="btn btn-primary m-b-5 m-t-5" id="addrow"
                                                            style="float: left;" onclick="addRows();"><i
                                                                class="bx bx-plus" aria-hidden="true"></i></span>

                                                        <a href="{{ url('admin/product/variation/delete', $variation->id) }}"
                                ...
                                <div class="row" id="variations" style="display: none;">
                                    <div class="borderBp"  >
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label>Variation</label>
                                                <input type="text" name="ropeChain[]"
                                                    class="form-control" placeholder="0.68 Mm Thickness 18 Inch"
                                                    value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-12 rope-chan mt-3">
                                            <p id="line_no"></p>
                                            <span class="btn btn-primary m-b-5 m-t-5" 
                                ...
                                @php
                                    $rate = App\Models\Rating::where('product_id', $products->id)
                                        ->where('type', 'product')
                                        ->get();
                                ...
                                */
                                ...
                                <div class="">
                                    ...
                                    <input type="checkbox" name="color_added" id="color_added" class=""
                                        @if ($products->color_added != null) checked @endif>
