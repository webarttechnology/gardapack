    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <h6 class="mb-0 text-uppercase">Add Settings Options</h6>
                <hr />

                <form action="{{url('admin/settings/options/add/action')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="settings_key" required />
