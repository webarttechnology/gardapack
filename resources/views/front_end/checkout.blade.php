                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select onchange="getpriceDetails()" class="custom-select d-block w-100" id="country"
                                name="country" required>
                                @foreach ($countries as $key => $country)
                                    @if ($country->country != 'country')
                                        <option value="{{ $country->country }}"
                                            @if ($country->country == 'US') selected @endif>{{ $country->name }}
                                        </option>
                                    @endif
                                @endforeach
                            </select>
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between" id="shipment_cost">
                            <span id="ship_cost">Domestic Shipping</span>
                            <strong>$ 0</strong>
                        </li>
                    ...
                    <div class="col-md-12 mb-3" id="shipping_options">
                    ...
                    <div class="mb-5">
                        <button class="cstmbtn" type="submit" id="checkoutBtn" style="display: none;">Continue to
                            checkout</button>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 p-3 m-2">
                    <input type="checkbox" class="form-check-input" id="sameAsShipping"
                        onchange="toggleBillingAddress()" name="sameAsShipping">
                    <label class="form-check-label" for="sameAsShipping"><strong>Same As Shipping
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="bill_address2" name="bill_address2"
                                placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="custom-select d-block w-100" id="bill_country" name="bill_country"
                                required>
                                @foreach ($countries as $key => $country)
                                    @if ($country->country != 'country')
                                        <option value="{{ $country->country }}"
...
<script>
    ...
    function toggleBillingAddress() {
        if ($('#sameAsShipping').prop('checked')) {
            ...
            $('#bill_name, #bill_lastName, #bill_email, #bill_phone, #bill_address1, #bill_address2, #bill_country, #bill_town, #bill_state, #bill_zip')
...
<script>
    function getpriceDetails() {
        ...
        $.ajax({
            ...
            url: '{{ url('user/shipment/price/') }}' + '/' + totalPrice + '/' +
                country + '/' + shipping_option,
            ...
            success: function(response) {
                ...
                if (country == "US") {
                    ...
                    $('#shipment_cost').html('<span>Domestic Shipping: </span> <strong>$' + shipCost +
                        '</strong>');
                } else {
                    $('#shipping_options').hide();
                    $('#shipment_cost').html('<span>International Shipping: </span> <strong>$' +
                        shipCost + '</strong>');
                }
